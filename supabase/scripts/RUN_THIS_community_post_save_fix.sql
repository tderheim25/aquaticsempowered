-- =============================================================================
-- COMMUNITY POST SAVE FIX — paste this entire file into Supabase → SQL Editor → Run
-- (Same as supabase/migrations/0032_community_post_save_fix.sql)
-- After success: sign out of the app, then sign back in.
-- =============================================================================
